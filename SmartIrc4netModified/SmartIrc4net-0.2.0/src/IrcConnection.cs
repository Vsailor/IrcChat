    ...
    public class IrcConnection
    {
        ...
        public bool Connect(string[] addresslist, int port)
        {
            ...
            try {
                ...
                _Reader = new StreamReader(_TcpClient.GetStream(), new PrimaryOrFallbackEncoding(new UTF8Encoding(false, true), _Encoding));
                _Writer = new StreamWriter(_TcpClient.GetStream(), new UTF8Encoding(false, false));
